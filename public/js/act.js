...
(function() {
    ...
    var myLatlng = new google.maps.LatLng(41.55661, -72.65690); // New York
    function init() {
        ...
        var contentString = '<div id="content">' +
            ...
            '<h4><i class="fa fa-car text-primary"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>Middletown, CT</b></h4>' +
            '<h4><i class="fa fa-envelope text-primary"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>info@brighterdawns.org</b></h4>' +
            '<h4><i class="fa fa-send text-primary"></i>&nbsp;&nbsp;&nbsp;&nbsp;<b>PHONE NUMBER</b></h4><br>' +
